...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 10, 2020 at 04:12 PM
...
(46, 58000, '2020-12-10', 1, 1, NULL, 1, 'văn ngọc');
...
(53, 'Cà Phê Đen 2', 'abd', 29000, 1),
(54, 'Cà Phê Đen 54', 'Cà phê là một thức uống được pha chế bằng hạt cà phê rang được lấy từ các loại quả mọng của cây Coffea.', 30000, 1),
(55, 'Cà Phê Khá Đen', 'ca phe la mot loai nuoc uong', 29000, 1),
(56, 'Cà Phê Khá Đen', 'ca phe la mot loai nuoc uong', 29000, 1),
(57, 'Cà Phê Khá Đen', 'ca phe la mot loai nuoc uong', 29000, 1),
...
--
ALTER TABLE `hinhmon`
  MODIFY `HinhMon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `mon`
  MODIFY `Mon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
